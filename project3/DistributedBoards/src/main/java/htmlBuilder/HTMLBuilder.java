...
public class HTMLBuilder {
	...
	/**
	 * Erstellt, die Boardseite f�r den Benutzer.
	 * 
	 * @param userID Die ID des Benutzers.
	 * @param boardID Die ID des Boards.
	 * @param p Die Berechtigung
	 * @return Die Boardseite f�r den Benutzer( mit den entsprechenden Berechtigungen.)
	 * @throws IOException
	 * @throws SQLException
	 */
...
//		page = splitHTMLPageAtMarker(boardListMarker, "WebContent\\HTML\\Profile.html");
	 ...
	 * @param boardID
	 * @param p Die Berechtigung.
	 * @return Eine HTML Liste von Benutzern mit Remove, Add Button f�r Admin.
	 * @throws SQLException
	 */
	...
	/**
	 * Entfernt die Markierung aus der Seite und gibt die 2 H�lften zur�ck.
	 * 
	 * @param marker
	 *            Die Markierung an der der neue Inhalt eingef�gt werden soll.
	 * @param path
	...
	/**
	 * 
	 * @param marker Die Markierung an der der neue Inhalt eingef�gt werden soll.
	 * @param page String der die HTML Seite darstellt.
	 * @return Ein Array mit den zwei H�lften.
	 */
