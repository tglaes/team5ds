...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/file_query.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/file_query ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/file.o: file.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file.o file.c
...
${OBJECTDIR}/socket_helper.o: socket_helper.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket_helper.o socket_helper.c
